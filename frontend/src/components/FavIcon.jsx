...
const FavIcon = ({displayAlert, selected}) => {
    return (
    <svg className='photo-list__fav-icon-svg'  width="20" height="17" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
          !!displayAlert &&
          <circle cx="21" cy="4" r="2.75" fill="#11d406" stroke="#C80000" strokeWidth="0.5"/>
      }
    </svg>
  );
};
